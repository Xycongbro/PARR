...
def eval_epoch(model, test_dataset, test_loader, opt, epoch):
    ...
    with torch.no_grad():
        ...
        for loc in unique_locations:
            ...
            mse, mae, rmse, mape, mspe, nse, bias, atpe = metric(loc_preds, loc_trues)
        ...
        for i in range(flat_preds.shape[1]):
            ...
            for loc in unique_locations:
                ...
                loc_preds = sorted_preds[loc_indices]
                loc_trues = sorted_trues[loc_indices]
                mse, mae, rmse, mape, mspe, nse, bias, atpe = metric(loc_preds[:, i], loc_trues[:, i])
...
def main(opt, iter_index):
    ...
    model_save_dir = 'models/448/best_iter_448_1_8_10.pth'
    if opt.eval:
